...
const FeaturesSection = () => {
  return (
    <section className="py-16 px-4 bg-[#f4f6fb]">
      <h2 className="text-2xl md:text-3xl font-bold text-center text-[#3b82f6] mb-8">
      ...
      <main className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        ...
        <ul className="space-y-6 text-xs md:text-sm text-gray-700 leading-relaxed">
          ...
          <li className="flex items-start gap-3">
            <span className="text-[#3b82f6] mt-1">
              <FiZap className="w-8 h-8" />
            </span>
            <div>
              <h3 className="text-base font-semibold text-[#3b82f6] mb-1">Lightning Fast</h3>
              <p>
          ...
          <li className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-base font-semibold text-[#3b82f6] mb-1">Easy To Use</h3>
              <p>
          ...
          <li className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-base font-semibold text-[#3b82f6] mb-1">Light Weight</h3>
              <p>
